...
func (m *TimeFail) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TimeTest != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTimefail(dAtA, i, uint64(github_com_vaniila_protobuf_types.SizeOfStdTime(*m.TimeTest)))
		n1, err := github_com_vaniila_protobuf_types.StdTimeMarshalTo(*m.TimeTest, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
...
func (m *TimeFail) Size() (n int) {
	...
	_ = l
	if m.TimeTest != nil {
		l = github_com_vaniila_protobuf_types.SizeOfStdTime(*m.TimeTest)
...
func (m *TimeFail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := github_com_vaniila_protobuf_types.StdTimeUnmarshal(m.TimeTest, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorTimefail = []byte{
	...
	0x2c, 0x13, 0xee, 0xcb, 0x33, 0x06, 0x81, 0x5d, 0x17, 0x92, 0x5a, 0x5c, 0xe2, 0xa4, 0x73, 0xe1,
	...
	0x26, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x35, 0x72, 0x6b, 0xc9, 0xee, 0x00, 0x00, 0x00,
}
